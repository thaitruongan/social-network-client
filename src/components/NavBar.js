             ...
             <Fragment>
                <Grid item sm={3} xs={12}>
                  <div className={classes.sectionDesktop}>
                      <h3 onClick={()=>window.location.href = "/home"} style={{cursor:'pointer'}}>Social Network</h3>
                  </div>                
                </Grid>
                <Grid item sm={6} xs={12}>
                  <div className={classes.sectionDesktop}>
                      <PostFeed/>
                        <IconButton aria-label="show 4 new mails" color="inherit" onClick={()=>window.location.href = "/home"}>
